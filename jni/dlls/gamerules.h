...
enum RewardAccount
{
	REWARD_TARGET_BOMB		= 0,
	REWARD_VIP_ESCAPED		= 0,
	REWARD_VIP_ASSASSINATED		= 0,
	REWARD_TERRORISTS_ESCAPED	= 0,
	REWARD_CTS_PREVENT_ESCAPE	= 0,
	REWARD_ESCAPING_TERRORISTS_NEUTRALIZED	= 0,
	REWARD_BOMB_DEFUSED		= 0,
	REWARD_BOMB_PLANTED		= 0,
	REWARD_BOMB_EXPLODED		= 0,
	REWARD_CTS_WIN			= 0,
	REWARD_TERRORISTS_WIN		= 0,
	REWARD_ALL_HOSTAGES_RESCUED	= 0,

	// the end round was by the expiration time
	REWARD_TARGET_BOMB_SAVED	= 0,
	REWARD_HOSTAGE_NOT_RESCUED	= 0,
	REWARD_VIP_NOT_ESCAPED		= 0,

	// loser bonus
	REWARD_LOSER_BONUS_DEFAULT	= 0,
	REWARD_LOSER_BONUS_MIN		= 0,
	REWARD_LOSER_BONUS_MAX		= 0,
	REWARD_LOSER_BONUS_ADD		= 0,

	REWARD_RESCUED_HOSTAGE		= 0,
	REWARD_KILLED_ENEMY		= 0,
	REWARD_KILLED_VIP		= 0,
	REWARD_VIP_HAVE_SELF_RESCUED	= 0,
...
{
	PAYBACK_FOR_KILLED_TEAMMATES	= -0,
};
